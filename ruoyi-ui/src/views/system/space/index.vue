  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="车位编号" prop="parkingSpaceCode">
        <el-input
          v-model="queryParams.parkingSpaceCode"
          placeholder="请输入车位编号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:space:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:space:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="spaceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车位编号" align="center" prop="parkingSpaceCode" />
      ...
      <el-table-column label="是否占用" align="center" prop="isOccupy" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否占用" prop="isOccupy">
          <el-input v-model="form.isOccupy" placeholder="请输入是否占用" />
        </el-form-item>
      </el-form>
...
<script>
import { listSpace, getSpace, delSpace, addSpace, updateSpace } from "@/api/system/space";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除码头等待停车位明细编号为"' + ids + '"的数据项？').then(function() {
        return delSpace(ids);
      }).then(() => {
        this.getList();
